<nav x-data="{ open: false }" class="bg-white border-b border-gray-100 sticky top-0 z-50 shadow">
            ...
            @auth
                <div class="hidden sm:flex sm:items-center sm:ml-6">
                    <x-nav-link :href="route('recipe.create')" :active="request()->routeIs('recipe.create')">
                        <i class="bi bi-pencil"></i><div class="px-1">レシピ投稿</div>
                    </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-responsive-nav-link :href="route('recipe.index')" :active="request()->routeIs('dashboard')">
                レシピ一覧
